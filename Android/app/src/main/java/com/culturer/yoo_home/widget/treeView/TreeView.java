...
import com.culturer.yoo_home.widget.treeView.util.LooperFlag;
...
//        paint.setStyle(Paint.Style.STROKE);
        ...
        mPaint.setColor(mContext.getColor(R.color.text_grey));
...
//        path.quadTo(toX - dp2px(mContext, 15), toY, toX, toY);
        ...
        mPath.quadTo(toX - DensityUtils.dp2px(mContext, 15), toY, toX, toY);
